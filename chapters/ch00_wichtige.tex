...
\end{runintext}
\begin{formulabox}
\[ \oint \vec{E}\cdot\mathrm{d}\vec{A} = \frac{q_{\mathrm{in}}}{\varepsilon_0} \quad \text{Gauß E} \]
\formulasep
\[ \varphi = \frac{1}{4\pi\varepsilon_0}\,\frac{q}{r}, \quad \vec{E} = -\nabla\varphi \quad \text{Potenzial} \]
\formulanote{Zweck: Gauß (Fluss $\propto$ Ladung); Potenzial und E $= -\nabla\varphi$.}
\end{formulabox}
...
\formulanote{Zweck: Blindwiderstände; LC-Eigenfrequenz; Transformator-Übersetzung.}
\end{formulabox}
...
\begin{runintext}
Einführung in die Quantenphysik: Energie/Impuls von Photonen und die Heisenberg'sche Unschärferelation.
\end{runintext}
\begin{formulabox}
\[ E = h\nu, \quad p = h/\lambda \quad \text{Photon} \]
\formulasep
\[ \Delta x\,\Delta p \ge \hbar/2 \quad \text{Heisenberg} \]
\formulanote{Zweck: Photon Energie/Impuls; Unschärferelation.}
\end{formulabox}
