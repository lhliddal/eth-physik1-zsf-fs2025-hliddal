...
\newlength{\ZSFsubsectionBarBeforeSkip}\setlength{\ZSFsubsectionBarBeforeSkip}{12pt}    % Standard-Abstand vor SubsectionBar
...
\newlength{\ZSFpostChapterNudge}  \setlength{\ZSFpostChapterNudge}{4pt} % Wieder etwas enger an den Inhalt gebunden
